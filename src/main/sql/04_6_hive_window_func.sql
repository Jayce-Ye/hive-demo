...
load data local inpath '/opt/data/website_pv_info.txt' into table website_pv_info;
load data local inpath '/opt/data/website_url_info.txt' into table website_url_info;
